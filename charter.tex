...
El proyecto incluye:
\begin{itemize}
\item Desarrollo de un sistema de optimización personalizado: proporcionará recomendaciones para el ajuste biomecánico de la bicicleta, buscando maximizar el rendimiento (medido por la potencia y velocidad), la eficiencia y prevenir lesiones.
...
\item Ciclo continuo de análisis y retroalimentación: el sistema funcionará a través de las siguientes etapas:
    \begin{itemize}
        ...
        \item Optimización integral: un algoritmo de optimización analizará combinaciones para lograr el equilibrio perfecto entre:
            ...
            \end{itemize}
        \item Recomendación y re-evaluación: generación de un reporte con recomendaciones claras para ajustar la bicicleta, permitiendo nuevas sesiones de captura de datos para refinar el ajuste.
    \end{itemize}
