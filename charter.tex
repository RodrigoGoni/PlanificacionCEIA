...
\toprule
ID & Descripción de la tarea & Tipo \\
\midrule
\endhead % Encabezado para todas las páginas de la tabla

% --- Gestión y Documentación ---
\multicolumn{3}{l}{Grupo G: Gestión y documentación} \\
...
% --- Épica 1 ---
\multicolumn{3}{l}{Grupo E1: Adquisición y preprocesamiento de datos} \\
...
% --- Épica 2 ---
\multicolumn{3}{l}{Grupo E2: Modelado y optimización biomecánica} \\
...
% --- Épica 3 ---
\multicolumn{3}{l}{Grupo E3: Generación de recomendaciones y UX} \\
...
% --- Épica 4 ---
\multicolumn{3}{l}{Grupo E4: Validación y mejora continua} \\
